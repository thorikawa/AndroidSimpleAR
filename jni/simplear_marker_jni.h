...
#include <jni.h>
/* Header for class com_polysfactory_simplear_jni_NativeMarkerDetector */

#ifndef _Included_com_polysfactory_simplear_jni_NativeMarkerDetector
#define _Included_com_polysfactory_simplear_jni_NativeMarkerDetector
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_polysfactory_simplear_jni_NativeMarkerDetector
